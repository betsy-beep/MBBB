...
$query = "select password from internaluser where matricNo = '$matricNo'";
...
<div class="main">
    ...
    <form  name="myform" id="myform" onsubmit="return validateEUP()" method="POST" autocomplete="on" action="editpassword-process.php?matricNo=<?php echo $matricNo; ?>">
    <center><h2>Password : </h2></center>
  
   <input class="psw" type="password" value="<?php echo $row["password"]; ?>"  id="psw" name="psw">
   <center><input type="checkbox" onClick="myFunction()" style="width:10px"; >Show </center><br>
    <input class="psw" type="password" placeholder="Confirm Password" id="cpsw" name="cpsw" >
  <center><input type="checkbox" onClick="mySecFunction()" style="width:10px"; >Show </center><br>
