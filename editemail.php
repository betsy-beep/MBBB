...
<div class="main">
    ...
    <form  name="myform" id="myform" onsubmit="return validateEUP()" method="POST" autocomplete="on" action="editemail-process.php?matricNo=<?php echo $matricNo; ?>">
    <center><h2>Email : </h2></center>
  <input class="email" type="text" id="email" placeholder="abcd40@gmail.com" name="email">
